...
After binding both datasets, we obtain `r nrow(eddy_complete_no_error)` observations.
In order to know how many of them are grouped within the same date_time, I
grouped all the observations per month and year.
...
september and october 2017 and april 2019 are dates on which observations from
