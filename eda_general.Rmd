...
# sturges <- fdt(x = complete_differences$difference)
# 
# sturges$table %>% 
#       separate(
#       col = "Class limits",
...
#       sep = ","
#     ) %>%
#     mutate(inferior = as.numeric(str_replace(inferior, "\\[", "")),
#            superior = as.numeric(str_replace(superior, "\\)", ""))) %>%
#     rename(
#       "Frequency" = "f",
#       "Relative Frequency" = "rf",
#       "Relative Frequency %" =  "rf(%)",
#       "Accumulative Frequency" = "cf",
#       "Accumulative Frequency %" = "cf(%)"
#     ) %>%
#     gt()
...
complete_differences %>% 
  ...
  geom_histogram() +
  labs(title = "Most of the Latent Heat FLux values between both towers do not differ",
       subtitle = "Carbon Latent Heat Flux values minus the Principe Latent Heat Flux values",
       x = "Differences between carbon and principe towers Latent Heat Flux values",
