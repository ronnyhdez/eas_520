...
```{r}
evapotranspiration %>% 
  select(latent_heat_flux, evapotranspiration, air_temperature) %>% 
  head(20) %>% 
  gt()
```
...
# Preguntas
 ...
 - ¿Dónde puedo ver las unidades en que están las mediciones? con steve puedo
 averiguar
 ...
 - ¿La temperatura del aire es la que obtengo con el mean_thermocouple_temp?
   - Esto lo puedo obtener con los datos de otras torres.
   
dividir grafico por estaciones: paper de ian donde saca las fechas.
